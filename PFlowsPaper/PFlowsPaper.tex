...
\begin{table}[h]
	\centering
	\caption{Truncated normal distribution fitting parameters and number of CAFOs in each cluster for the scenarios considered regarding CAFOs size distribution.} \label{table:CAFOsSizeScenarios}
