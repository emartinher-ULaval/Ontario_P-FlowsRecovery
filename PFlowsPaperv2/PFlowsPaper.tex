...
\begin{figure}[H]
	\centering
	%	\begin{subfigure}[t]{0.5\linewidth}
	\includegraphics[width=0.9\linewidth, trim={0cm 0cm 0cm 0cm},clip]{Figures/Results_PlotSummary.pdf} 
...
\begin{figure}[H]
	\centering
	%	\begin{subfigure}[t]{0.5\linewidth}
	\includegraphics[width=0.9\linewidth, trim={0cm 0cm 0cm 0cm},clip]{Figures/Results_PlotSummarySpecific.pdf} 
